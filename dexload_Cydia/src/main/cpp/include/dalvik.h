...
DEX_INLINE struct ClassObject* dvmDexGetResolvedClass(const DvmDex* pDvmDex,
                                                  u4 classIdx)
{
    assert(classIdx < pDvmDex->pHeader->typeIdsSize);
    return pDvmDex->pResClasses[classIdx];
}
DEX_INLINE void dvmDexSetResolvedClass(DvmDex* pDvmDex, u4 classIdx,
...
typedef bool (*dvmVerifyClass_func)(ClassObject*);
typedef bool (*dvmVerifyMethod_func)(Method* meth);
typedef ClassObject* (*dvmFindClassNoInit_func)(char*, Object*);
typedef ClassObject* (*dvmResolveClass_func)(ClassObject* referrer, u4 classIdx,
...
dvmVerifyClass_func dvmVerifyClass_fnPtr;
dvmVerifyMethod_func dvmVerifyMethod_fnPtr;
dvmFindClassNoInit_func dvmFindClassNoInit_fnPtr;
